...
namespace SmartLibrary.Controllers
{
    public class GendersController : Controller
    {
        ...
        public GendersController(RepositoryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("GenderName,IsActive")] Gender gender)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("GenderId,GenderName,IsActive")] Gender gender)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'RepositoryContext.Genders'  is null.");
            }
            var gender = await _context.Genders.FindAsync(id);
            if (gender != null)
            {
